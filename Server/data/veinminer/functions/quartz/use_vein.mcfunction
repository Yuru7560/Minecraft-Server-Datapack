...
execute if entity @s[nbt={SelectedItem:{tag:{Enchantments:[{id:"minecraft:silk_touch"}]}}}] at @e[type=item,limit=1,distance=..1,nbt={Item:{id:"minecraft:nether_quartz_ore"},Age:0s},sort=nearest] run function veinminer:quartz/ft5/start
